...
class _InventoryDescriptionState extends State<InventoryDescription> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20), bottom: Radius.circular(20))),
      title:
      Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.vertical(top: Radius.circular(30), bottom: Radius.circular(100)),
        ),
        ...
        child: Column(
            ...
            children: [
              Text('${widget.ItemName}', style: TextStyle(fontSize: 20, color: text_Color, fontWeight: FontWeight.w600),),
            ]
        ),
      ),
      content: Column(
          ...
          children: [
            ...
            child: Image.network('https://m.media-amazon.com/images/I/61ZzyBQhnQS._AC_UL1500_.jpg', height: 100,),
            ),
